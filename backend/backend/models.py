...
class AnomalyData(models.Model):
  ...
  intensity_file_id = models.IntegerField(default=0, editable=False)
  impact_file_id = models.IntegerField(default=0, editable=False)
  attribute_file_id = models.IntegerField(default=0, editable=False)
